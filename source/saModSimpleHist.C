// $Id: saModSimpleHist.C,v 1.8 2016/02/28 05:32:50 jinhuang Exp $                                                                                             
...
saModSimpleHist::saModSimpleHist(const std::string &name) :
    ...
    _h_vtx(NULL), _h_vtx_xz(NULL), _h_vtx_yz(NULL), //
    _h_DCA_Phi_Arm(NULL), //
    _h_DCA_Pz_Arm(NULL), //
    _h_DCA_Phi_z_Arm0(NULL), _h_DCA_Phi_z_Arm1(NULL), //
    _h_fvtx_DCA_Phi_Arm(NULL), _h_fvtx_DCA_Pz_Arm(NULL), _h_Normalization(NULL), //
    _event_vertex(3) //
{
          ...
          if (good_muID_muon)
            {
              ...
              if (abs(sm->get_pz_fvtxmutr()) > 3)
                {
                  _h_DCA_Phi_Arm->Fill(disp_pt_vtx_kalman, phi,
                      SingleMuons_arm);
