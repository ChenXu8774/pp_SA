		...
		)
{
	...
	gSystem->Load("/gpfs/mnt/gpfs02/phenix/spin/spin2/chenxu/spinAnalyzer/pAu_SA/install/lib/libspin_analyzer.so");
	...
	sa->set_rellumi_costom_flag(saHist::BLUE_SPIN_DEPENDENT);
