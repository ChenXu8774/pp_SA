...
void
saSpinAnalyzer::set_rellumi_costom_flag (saHist::sa_flags_t f)
{
  if(dynamic_cast<saModLoadSpinInfo*> (_mspin))
    dynamic_cast<saModLoadSpinInfo*> (_mspin)->set_costom_flag(f);
}
