...
protected:
  ...
  //! get spin state of a crossing. For bad crossings return saEventProperty::UNKOWN
  virtual saEventProperty::sa_single_spin_state
  get_single_spin_state(int crossing, std::string name);
...
public:
  ...
  void
  set_costom_flag(saHist::sa_flags_t f)
  {
    _costum_flag = f;
  }
...
private:
  ...
  //! custom flag
  saHist::sa_flags_t _costum_flag;
