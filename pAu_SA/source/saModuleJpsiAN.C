...
//	_pT_bins[3] = 10.;
	...
	_pT_MinJpsiMs[NORTH][0] =2.88121;
	_pT_MaxJpsiMs[NORTH][0] =3.43513;
	_pT_MinJpsiMs[NORTH][1] =2.87472;
        _pT_MaxJpsiMs[NORTH][1] =3.45992;

        _pT_MinJpsiMs[SOUTH][0] =2.84384;
        _pT_MaxJpsiMs[SOUTH][0] =3.39732;
        _pT_MinJpsiMs[SOUTH][1] =2.84184;
        _pT_MaxJpsiMs[SOUTH][1] =3.40799;
	
	_xF_MinJpsiMs[NORTH] = 2.879; 
	_xF_MaxJpsiMs[NORTH] = 3.423;

	_xF_MinJpsiMs[SOUTH] = 2.831;
	_xF_MaxJpsiMs[SOUTH] = 3.405;
...
//		if(!((triglv1->get_lvl1_trigscaled() & 0x00400000)||(triglv1->get_lvl1_trigscaled() & 0x00100000)||(triglv1->get_lvl1_trigscaled() & 0x00800000)||(triglv1->get_lvl1_trigscaled() & 0x00200000))) continue;
		...
		{if(!((triglv1->get_lvl1_trigscaled() & 0x00400000)||(triglv1->get_lvl1_trigscaled() & 0x00100000))) continue;}

		if(dimuon->get_Tr0_pz()<0)
		{if(!((triglv1->get_lvl1_trigscaled() & 0x00800000)||(triglv1->get_lvl1_trigscaled() & 0x00200000))) continue;} 
