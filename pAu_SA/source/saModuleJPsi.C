// $Id: saModuleJPsi.C,v 1.5 2016/02/28 05:32:50 jinhuang Exp $                                                                                             
...
saModuleJPsi::saModuleJPsi(const std::string &name) :
  saModuleBase(name), 
  _h_mass_pT(NULL),_h_pT_like(NULL), _h_pT(NULL), _h_pT_m(NULL),
  _h_pT_p(NULL), _h_pT_side(NULL), _h_pT_wide(NULL), 
  _h_mass_pT_FVTX(NULL),_h_pT_like_FVTX(NULL), _h_pT_FVTX(NULL), _h_pT_m_FVTX(NULL),
  _h_pT_p_FVTX(NULL), _h_pT_side_FVTX(NULL), _h_pT_wide_FVTX(NULL), 
  _h_mass_pT_sel(NULL), _h_pT_like_sel(NULL), _h_pT_sel(NULL), _h_pT_m_sel(NULL),
