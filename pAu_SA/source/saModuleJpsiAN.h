// $Id: saModuleJpsiAN.h,v 1.4 2016/02/28 05:32:50 jinhuang Exp $                                                                                             
...
class saModuleJpsiAN  : public saModuleBase
{
	public:
		...
		float _xF_MinJpsiMs[2];
		float _xF_MaxJpsiMs[2];
		double _pT_bins[3];
		double _xF_bins[3];
...
//		int MAX_FILL_NUM;
		...
		saHist * _sah_xF_os_sig_n;
		saHist * _sah_xF_os_sig_s;
		saHist * _sah_xF_os_lsb_n;
                saHist * _sah_xF_os_lsb_s;
